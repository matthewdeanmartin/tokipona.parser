...
{
    /// <summary>
    /// This was created in case Monster succeeds in pushing back on the HTTP request signing burden. If they
    /// lose that arguement, then this will be OBE.
    /// </summary>
    [AttributeUsage(AttributeTargets.Class | AttributeTargets.Method, AllowMultiple = false)]
    public class BasicAuthentication : BasicAuthenticationFilterAttribute
    {
        protected override bool OnAuthorizeUser(string username, string password, HttpActionContext actionContext)
        {
            ...
            {
               if(Roles.IsUserInRole(username,"Big Cheese"))   
                   return true;
            }
            return false;
        }
    ...
    public class BasicAuthenticationFilterAttribute : AuthorizationFilterAttribute
    {
        ...
        public BasicAuthenticationFilterAttribute(bool active)
        {
            Active = active;
        }
