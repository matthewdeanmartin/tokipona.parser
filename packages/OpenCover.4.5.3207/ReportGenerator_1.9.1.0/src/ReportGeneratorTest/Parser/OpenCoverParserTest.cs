...
namespace Palmmedia.ReportGeneratorTest.Parser
{
    ...
    {
        private static readonly string filePath1 = Path.Combine(FileManager.GetReportDirectory(), "OpenCover.xml");

        private static readonly string filePath2 = Path.Combine(FileManager.GetReportDirectory(), "OpenCoverWithTrackedMethods.xml");
        ...
        public void MethodMetricsTest()
        {
            ...
            Assert.AreEqual(72.73M, metrics.First().Metrics.ElementAt(1).Value, "Wrong value of metric");
