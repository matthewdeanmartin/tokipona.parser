...
namespace Palmmedia.ReportGeneratorTest.Parser
{
    ...
    /// to contain all VisualStudioParser Unit Tests
    /// </summary>
    [TestClass]
    public class VisualStudioParserTest
    {
        private static readonly string filePath = Path.Combine(FileManager.GetReportDirectory(), "VisualStudio2010.coveragexml");
